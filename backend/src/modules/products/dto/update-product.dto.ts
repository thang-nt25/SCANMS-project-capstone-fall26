...
export class UpdateProductDto {
  @ApiPropertyOptional({ example: 'TECH-ANC-01', description: 'Mã SKU duy nhất của sản phẩm' })
  @IsOptional()
  @IsString()
  sku?: string;

  @ApiPropertyOptional({ example: 'Tai nghe Bluetooth Chống Ồn ANC Pro X', description: 'Tên sản phẩm' })
  @IsOptional()
  @IsString()
  title?: string;
  ...
  @ApiPropertyOptional({ example: 'Chống ồn chủ động Hybrid ANC 45dB, Pin 40 giờ liên tục', description: 'Mô tả chi tiết sản phẩm' })
  @IsOptional()
  @IsString()
  description?: string;

  @ApiPropertyOptional({ example: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=500', description: 'URL ảnh đại diện sản phẩm' })
  @IsOptional()
  @IsString()
  imageUrl?: string;

  @ApiPropertyOptional({ example: 459000, description: 'Giá bán thực tế (VNĐ)' })
  @IsOptional()
  ...
  @ApiPropertyOptional({ example: true, description: 'Trạng thái kinh doanh sản phẩm' })
  @IsOptional()
  @IsBoolean()
  isActive?: boolean;
}
