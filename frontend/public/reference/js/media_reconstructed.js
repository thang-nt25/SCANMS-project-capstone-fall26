...
if (storedSubs && storedSubs.length > 0) {
  storedSubs.forEach((sub) => {
    if (!mediaAssets.some((a) => a.id === sub.id)) {
...
export function mediaPage(globalState = {}) {
  ...
  const mySubmissions = mediaAssets.filter((a) => a.isSubmission || a.status === "PENDING");
  const shopAssets = mediaAssets.filter((a) => !a.isSubmission && a.status !== "PENDING");
        ...
        <section class="media-compact-banner my-reviews-banner">
            ...
            <div class="media-banner-info">
              <div class="media-banner-title-row">
                ...
                <span class="media-banner-category-tag">
                  <i class="ph-bold ph-clock"></i> Chờ Shop phê duyệt (${myReviewsCount} video)
                </span>
              </div>
          ...
          <div class="media-banner-metrics-capsule">
            ...
            <div class="banner-metric-block">
              ...
              <strong class="metric-val" style="color:#D97706;">Chờ duyệt</strong>
            </div>
            <div class="banner-metric-sep"></div>
...
function renderAssetCard(asset) {
  ...
  const isSubmission = Boolean(asset.isSubmission || asset.status === "PENDING");
...
export function bindMedia(root = document, context = {}) {
  ...
  if (landingBtn) {
    landingBtn.onclick = () => {
      window.top.location.assign("/products/serum-vitamin-c");
    };
  }
